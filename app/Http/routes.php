...
Route::get('/useredit/{uid}/{mode}', ['middleware' => 'authcheck:End User', 'uses' =>'UsereditController@getIndex']);
Route::post('/useredit/{uid}/{mode}', ['middleware' => 'authcheck:End User', 'uses' =>'UsereditController@postIndex']);
